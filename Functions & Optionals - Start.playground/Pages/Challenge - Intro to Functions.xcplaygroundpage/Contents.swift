...
printFullName(firstName: "Carlos Eduardo", lastName: "Alves de Godoi")
...
printFullName("Carlos Eduardo", "Alves de Godoi")
...
let fullName = calculateFullName(firstName: "Carlos Eduardo", lastName: "Alves de Godoi")
...
let (_, nameLength) = calculateFullNameWithLength(firstName: "Carlos Eduardo", lastName: "Alves de Godoi")
nameLength
//: [Next](@next)
